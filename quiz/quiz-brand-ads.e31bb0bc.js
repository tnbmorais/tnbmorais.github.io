...
var quizData = _interopRequireWildcard(require("./quiz-data.json"));
...
var quizItem = (0, _quizData.getQuizData)(quizId);
...
document.querySelector('.music').appendChild(getIframeContent(quizItem.music)); // On Click show movie Information

solutionButton.addEventListener('click', function (event) {
  event.target.style.display = 'none';
  document.querySelector('.video').appendChild(getIframeContent(quizItem.video));
  document.querySelector('.video h1').appendChild(getTitleContent(quizItem.title));
});
},{"./quiz-data.service":"quiz-data.service.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/quiz-brand-ads.e31bb0bc.map